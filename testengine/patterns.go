...
func LoadDefaultPatterns() (*Patterns, error) {
...
func init() {
	var err error
	if DefaultPatterns, err = LoadDefaultPatterns(); err != nil {
		log.Fatalf("Failed to load default patterns from internal source due to error %s", err.Error())
	}
}
